<?php
namespace Magenteiro\CustomerStandardizer\Plugin\Api;

class CustomerRepositoryInterfacePlugin
{
    public function beforeSave (\Magento\Customer\Api\CustomerRepositoryInterface $subject, \Magento\Customer\Api\Data\CustomerInterface $customer, $passwordHash = null)
    {
